...
echo __( 'Someone requested that the password be reset for the following account:', 'bs4' ) . "\r\n\r\n";
echo esc_url( network_home_url( '/' ) ) . "\r\n\r\n";
echo sprintf( __( 'Username: %s', 'bs4' ), $user_login ) . "\r\n\r\n";
echo __( 'If this was a mistake, just ignore this email and nothing will happen.', 'bs4' ) . "\r\n\r\n";
echo __( 'To reset your password, visit the following address:', 'bs4' ) . "\r\n\r\n";
