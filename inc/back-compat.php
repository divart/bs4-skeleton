...
function bs4_upgrade_notice() {
	$message = sprintf( __( 'Bootstrap 4 requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'bs4' ), $GLOBALS['wp_version'] );
...
function bs4_customize() {
	wp_die( sprintf( __( 'Bootstrap 4 requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'bs4' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function bs4_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Bootstrap 4 requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'bs4' ), $GLOBALS['wp_version'] ) );
	}
}
