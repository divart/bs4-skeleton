 ...
 */
?>
<form id="whats-new-form" action="<?php bp_activity_post_form_action(); ?>" method="post" name="whats-new-form" class="card activity-post-form" role="complementary">
    <?php
    /**
    ...
    <div class="card-block media">
        <?php bp_loggedin_user_avatar( 'class=avatar d-flex align-self-center&width=' . bp_core_avatar_thumb_width() . '&height=' . bp_core_avatar_thumb_height() ); ?>
        <div id="whats-new-content-bs" class="media-body">
            <div id="whats-new-textarea-bs">
                <div class="form-group">
                    ...
                    <textarea id="whats-new-bs" name="whats-new" class="bp-suggestions form-control" placeholder="<?php esc_attr_e( 'Start writing&hellip;', 'bs4' ); ?>" rows="2"
