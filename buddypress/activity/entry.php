	...
	<div class="activity-content">
		...
		<div class="activity-meta">
			...
			<?php if ( bp_get_activity_type() == 'activity_comment' ) : ?>
				...
				<a href="<?php bp_activity_thread_permalink(); ?>" class="button view bp-secondary-action" title="<?php esc_attr_e( 'View Conversation', 'bs4' ); ?>"><?php _e( 'View Conversation', 'bs4' ); ?></a>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_comment() ) : ?>
					...
					<a href="<?php bp_activity_comment_link(); ?>" class="button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( __( 'Comment %s', 'bs4' ), '<span>' . bp_activity_get_comment_count() . '</span>' ); ?></a>
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action"><?php _e( 'Favorite', 'bs4' ); ?></a>

					<?php else : ?>

						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action"><?php _e( 'Remove Favorite', 'bs4' ); ?></a>
			...
			<?php if ( is_user_logged_in() && bp_activity_can_comment() ) : ?>
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-content">
						...
						<input type="submit" name="ac_form_submit" value="<?php esc_attr_e( 'Post', 'bs4' ); ?>" /> &nbsp; <a href="#" class="ac-reply-cancel btn btn-secondary"><?php _e( 'Cancel', 'bs4' ); ?></a>
