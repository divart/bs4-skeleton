			...
			<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
				...
				<div class="submit" id="previous-next">
					...
					<?php if ( !bp_is_first_group_creation_step() ) : ?>
						...
						<input type="button" id="group-creation-previous" name="previous" value="<?php esc_attr_e( 'Back to Previous Step', 'buddypress' ); ?>"  class="btn btn-secondary" onclick="location.href='<?php bp_group_creation_previous_link(); ?>'" />
					...
					<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" id="group-creation-next" name="save" value="<?php esc_attr_e( 'Next Step', 'buddypress' ); ?>" class="btn btn-secondary" />
					...
					<?php if ( bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" id="group-creation-create" name="save" value="<?php esc_attr_e( 'Create Group and Continue', 'buddypress' ); ?>" class="btn btn-secondary" />
					...
					<?php if ( bp_is_last_group_creation_step() ) : ?>
						...
						<input type="submit" id="group-creation-finish" name="save" value="<?php esc_attr_e( 'Finish', 'buddypress' ); ?>" class="btn btn-secondary" />
