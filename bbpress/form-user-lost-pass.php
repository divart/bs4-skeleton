...
<form method="post" action="<?php bbp_wp_login_action( array( 'action' => 'lostpassword', 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<fieldset class="bbp-form">
		<legend><?php _e( 'Lost Password', 'bs4' ); ?></legend>

		<div class="bbp-username">
			<div class="form-group">
				<label for="user_login" class="hide"><?php _e( 'Username or Email', 'bs4' ); ?>: </label>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="btn btn-secondary button submit user-submit"><?php _e( 'Reset My Password', 'bs4' ); ?></button>
