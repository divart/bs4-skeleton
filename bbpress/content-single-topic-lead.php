...
<div id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
	...
	<li class="bbp-header card-block">

		<div class="bbp-topic-author"><?php  _e( 'Creator', 'bs4' ); ?></div><!-- .bbp-topic-author -->
	...
	<li class="bbp-footer card-block">

		<div class="bbp-topic-author"><?php  _e( 'Creator',  'bs4' ); ?></div>
