            ...
            <h2 class="hero-title"><?php the_title_attribute(); ?></h2>
             <div class="hero-content hidden-xs">
                ...
                if (isset($firmasite_settings["showcase-calltoaction"]) && !empty($firmasite_settings["showcase-calltoaction"])) {
                    ...
                    _e( 'Continue reading <span class="meta-nav">&rarr;</span>', 'bs4' ); 
                }
             ...
             <?php get_template_part( 'templates/product/showcase/price' , get_post_format() ); ?>
             <?php get_template_part( 'templates/product/showcase/add-to-cart' , get_post_format() ); ?>
